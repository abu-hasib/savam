 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.savam.staging
 */

const BUNDLE_ID = 'com.savam'; // ios bundle id
const PACKAGE = 'com.savam'; // android package name
const NAME = 'Savam'; // app name
